<template>
  <div class="dashboard">
    <Header></Header>
    <main>
      <Toolbar v-on:show-form="toggleForm" />
      <Team :toggleForm="toggleForm" :fetchUsers="fetchUsers" :users="users" />
...
export default {
  ...
  setup() {
    ...
    return {
      users, fetchUsers, formActive, toggleForm, userId
    }
  },
  mounted() {
    this.fetchUsers();
